    ...
    return (
        <header className="relative flex items-center justify-between px-8 py-5 bg-gradient-to-r from-[#4A3F71] to-[#5E507F] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-xl tracking-tight">QuantaAI</span>
            </div>

            <div className="flex items-center space-x-1">
                <a onClick={handleComingSoon} className="text-white/80 text-xs px-4 py-2 font-medium hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 cursor-pointer">HOME</a>
                ...
                <a onClick={handleComingSoon} className="text-white/80 text-xs px-4 py-2 font-medium hover:text-white hover:bg-white/10 rounded-lg transition-all duration-200 cursor-pointer">SETTINGS</a>
            </div>
        </header>
    )
}
